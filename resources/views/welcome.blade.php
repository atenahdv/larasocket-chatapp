            ...
            <div class="flex flex-col justify-around">
                <div class="space-y-6">
                    ...
                    <h1 class="text-5xl font-extrabold tracking-wider text-center text-gray-600">
                        {{ config('app.name') }}
                        Hello! some changes on some files.
                    </h1>
                    ...
                    <ul class="list-reset">
                        ...
                        @if (Route::has('chat'))
                            ...
                            <li class="inline px-4">
                            <a href="{{ route('chat') }}" class="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">Chat   
                            </a>
                            </li>
